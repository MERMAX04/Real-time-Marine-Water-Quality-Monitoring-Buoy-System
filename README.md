...
## ค่าที่วัด (8 พารามิเตอร์ — เฉพาะ probe ที่ sensor จริงอ่านได้ ยืนยันด้วย read_sensor.py)
...
> คลอโรฟิลล์/ORP/น้ำมัน/สาหร่าย = ยังไม่ติด probe (อ่านได้ 0) จึงซ่อนไว้ก่อน — คอลัมน์ยังอยู่ใน Supabase เปิดคืนได้ทันทีถ้าติด probe เพิ่ม
